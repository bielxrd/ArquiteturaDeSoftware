package Template.bestbuy.before;

import Template.bestbuy.before.model.Buyer;
import Template.bestbuy.before.model.Cart;
import Template.bestbuy.before.model.Category;
import Template.bestbuy.before.model.Product;
import Template.bestbuy.before.service.BestBuyOfferService;
...
public class Client {
    public static void main(String[] args) {
        ...
        Product notebook = new Product("Macbook", 999.99d, Category.ELETRONICS, 10d);
        Product shoes = new Product("Nike Shoes", 200d, Category.SPORTS, 1.25d);
        Product shorts = new Product("Shein Clothe", 20d, Category.CLOTHES, 0.5d);
